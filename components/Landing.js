...
export default function Landing() {
  return (
    <div className="mx-20 text-left grid grid-cols-12 items-center">
      <div className="col-span-7">
        <div className="font-roboto text-xl leading-none tracking-wider">
          Hello, I'm
        </div>
        <h1 className="text-6xl font-extrabold pt-0 text-coral tracking-wider">
          Andre Novado
        </h1>
        <div className="text-lg font-semibold text-rose">A Web Developer</div>
